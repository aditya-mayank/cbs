...
public class UserLoginController {
        ...
        Task<Void> task = new Task<>() {
            ...
            protected Void call() {
                try {
                    ...
                    List<Cycle> cycles = sampleCycles();
    ...
    private static class Cycle {
        ...
        final double lat;
        final double lon;
        Cycle(String model, double lat, double lon) { this.model = model; this.lat = lat; this.lon = lon; }
    }

    private static class CycleDistance {
        final Cycle cycle;
        final double distKm;
        CycleDistance(Cycle cycle, double distKm) { this.cycle = cycle; this.distKm = distKm; }
    }

    private List<Cycle> sampleCycles() {
